...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Konichiwa ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: DylonKejhu to take your WhatsApp usage into next level.
...
I am *StG-44*, a bot developed by *DylonKejhu*.
